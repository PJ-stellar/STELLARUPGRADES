...
export default async function handler(req, res) {
  ...
  if (currentPage) {
    ...
    else if (currentPage.indexOf('/partner') !== -1) pageContext += ' This visitor was referred by someone (a contractor, friend, real estate agent, etc.) and landed on the Partner referral page. They may have a referral card worth $1,000 off their solar install. They are a WARM lead — do NOT over-educate them about solar basics. Your goal is to get them to fill out the form or call (780) 200-5265. Key points: (1) Welcome them and acknowledge the referral: "Welcome! Looks like someone connected you with us — great choice." (2) Be direct about the $1,000 savings: "As a referred homeowner, you qualify for $1,000 off your solar installation." (3) They qualify for Preferred Partner Pricing. Focus on booking the assessment, not giving a solar education. (4) If they ask about pricing: "Your referral gives you access to our Preferred Partner Pricing. The exact savings depend on your home — that\'s what the free assessment figures out. Want to book one?" (5) If they ask about the company: mention 500+ installs, 5.0 Google rating, 100% in-house Red Seal electricians, no subcontractors, been in Edmonton since 2018. (6) If they hesitate: "The assessment is completely free, takes about 15 minutes, and there\'s zero obligation. We actually tell about 10% of homeowners that solar doesn\'t make sense for them — so you\'ll get an honest answer either way."';
